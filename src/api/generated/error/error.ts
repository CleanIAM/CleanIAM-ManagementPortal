...
export const getError = async (params?: GetErrorParams, options?: RequestInit): Promise<getErrorResponse> => {
...
export const getGetErrorQueryOptions = <TData = Awaited<ReturnType<typeof getError>>, TError = unknown>(params?: GetErrorParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getError>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetErrorQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getError>>> = ({ signal }) => getError(params, { signal, ...requestOptions });
...
export function useGetError<TData = Awaited<ReturnType<typeof getError>>, TError = unknown>(
 params?: GetErrorParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getError>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const getErrorErrorCode = async (errorCode: number, options?: RequestInit): Promise<getErrorErrorCodeResponse> => {
...
export const getGetErrorErrorCodeQueryOptions = <TData = Awaited<ReturnType<typeof getErrorErrorCode>>, TError = unknown>(errorCode: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getErrorErrorCode>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetErrorErrorCodeQueryKey(errorCode);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getErrorErrorCode>>> = ({ signal }) => getErrorErrorCode(errorCode, { signal, ...requestOptions });
...
export function useGetErrorErrorCode<TData = Awaited<ReturnType<typeof getErrorErrorCode>>, TError = unknown>(
 errorCode: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getErrorErrorCode>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
