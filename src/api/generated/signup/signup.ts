...
export const getGetSignupQueryOptions = <TData = Awaited<ReturnType<typeof getSignup>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getSignup>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSignupQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSignup>>> = ({ signal }) => getSignup({ signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSignup>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetSignup<TData = Awaited<ReturnType<typeof getSignup>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getSignup>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetSignup<TData = Awaited<ReturnType<typeof getSignup>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getSignup>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const getPostSignupMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postSignup>>, TError,{data: PostSignupBody}, TContext>, request?: SecondParameter<typeof customFetch>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const usePostSignup = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postSignup>>, TError,{data: PostSignupBody}, TContext>, request?: SecondParameter<typeof customFetch>}
