...
export const getSignin = async (params?: GetSigninParams, options?: RequestInit): Promise<getSigninResponse> => {
...
export const getGetSigninQueryOptions = <TData = Awaited<ReturnType<typeof getSignin>>, TError = unknown>(params?: GetSigninParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getSignin>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSigninQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSignin>>> = ({ signal }) => getSignin(params, { signal, ...requestOptions });
...
export function useGetSignin<TData = Awaited<ReturnType<typeof getSignin>>, TError = unknown>(
 params?: GetSigninParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getSignin>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const postSignin = async (postSigninBody: PostSigninBody,
    params?: PostSigninParams, options?: RequestInit): Promise<postSigninResponse> => {
...
export const getPostSigninMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postSignin>>, TError,{data: PostSigninBody;params?: PostSigninParams}, TContext>, request?: SecondParameter<typeof customFetch>}
