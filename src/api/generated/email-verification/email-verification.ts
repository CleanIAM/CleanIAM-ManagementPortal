...
export const getEmailVerification = async ( options?: RequestInit): Promise<getEmailVerificationResponse> => {
...
export const getGetEmailVerificationQueryOptions = <TData = Awaited<ReturnType<typeof getEmailVerification>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEmailVerification>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetEmailVerification<TData = Awaited<ReturnType<typeof getEmailVerification>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEmailVerification>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Show a page announcing that email verification is required
...
export const postEmailVerification = async (postEmailVerificationBody: PostEmailVerificationBody, options?: RequestInit): Promise<postEmailVerificationResponse> => {
...
export const getPostEmailVerificationMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postEmailVerification>>, TError,{data: PostEmailVerificationBody}, TContext>, request?: SecondParameter<typeof customFetch>}
...
export const getEmailVerificationId = async (id: string, options?: RequestInit): Promise<getEmailVerificationIdResponse> => {
...
export const getGetEmailVerificationIdQueryOptions = <TData = Awaited<ReturnType<typeof getEmailVerificationId>>, TError = unknown>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEmailVerificationId>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEmailVerificationIdQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getEmailVerificationId>>> = ({ signal }) => getEmailVerificationId(id, { signal, ...requestOptions });
...
export function useGetEmailVerificationId<TData = Awaited<ReturnType<typeof getEmailVerificationId>>, TError = unknown>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEmailVerificationId>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Handle the user clicking on the email verification link
